...
namespace AcronymKata
{
    ...
    public class AcronymTest
    {
        ...
        [TestCase("Portable Network Graphics"
            , ExpectedResult = "PNG")]
        [TestCase("Ruby on Rails"
            , ExpectedResult = "ROR")]
        [TestCase("HyperText Markup Language"
            , ExpectedResult = "HTML")]
        [TestCase("First In, First Out"
            , ExpectedResult = "FIFO")]
        [TestCase("PHP: Hypertext Preprocessor"
            , ExpectedResult = "PHP")]
