...
public class RomanNumeralsTest
{
    ...
    [Fact]
    public void Number_3499()
    {
        Assert.Equal("MMMCDXCIX", 3499.ToRoman());
    }

    [Fact]
    public void Number_0_is_not_valid()
    {
        Assert.Equal("NOT VALID", 0.ToRoman());
    }

    [Fact]
    public void Number_4000_is_not_valid()
    {
        Assert.Equal("NOT VALID", 4000.ToRoman());
    }
}